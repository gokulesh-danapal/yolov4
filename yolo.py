...
"""
import torch
from yolo_backend import train, test
...
class options:
    def __init__(self):
        self.channels = 2 #fusion control: 3 for rgb, 2 for radar, 5 for fusion
        self.weights = '/home/danapalgokulesh/dataset/dense/radar_tiny.pt'
...
if not opt.evolve: 
    ...
    #results = test(hyp=hyp, opt=opt) #test_case =  'test_dense_fog'
else:
    import numpy as np
    import warnings
    import sys
