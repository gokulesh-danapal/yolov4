...
model = Darknet(4,anchors_g,channels = 5)
pre = {}
...
dest = fuse['model']
yolo =  torch.load('/home/danapalgokulesh/code/radar/DEHB/runs/train_rgb/exp_clear/weights/best.pt')['model']
keys = list(dest.keys())
rad = torch.load('/home/danapalgokulesh/code/radar/DEHB/runs/train_rgb/exp_full/weights/best.pt')['model']
#%%
