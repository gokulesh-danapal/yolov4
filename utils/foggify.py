...
# -*- coding: utf-8 -*-
"""
Created on Tue Aug 10 11:06:47 2021
...
def fogify(image, depth, beta):
    ...
    fog_image[get_rect_left] = np.clip(image[get_rect_left] * transmittance_[get_rect_left] + atmospheric_light(image) *
